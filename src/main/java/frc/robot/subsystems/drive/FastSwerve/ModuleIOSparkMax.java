...
public class ModuleIOSparkMax implements ModuleIO {
	...
	public ModuleIOSparkMax(int index) {
		switch (index) {
		case 0:
			driveSparkMax = new CANSparkMax(DriveConstants.kFrontLeftDrivePort,
					MotorType.kBrushless);
			turnSparkMax = new CANSparkMax(DriveConstants.kFrontLeftTurningPort,
					MotorType.kBrushless);
			...
			break;
		case 1:
			driveSparkMax = new CANSparkMax(DriveConstants.kFrontRightDrivePort,
					MotorType.kBrushless);
			turnSparkMax = new CANSparkMax(DriveConstants.kFrontRightTurningPort,
					MotorType.kBrushless);
			...
			break;
		case 2:
			driveSparkMax = new CANSparkMax(DriveConstants.kBackLeftDrivePort,
					MotorType.kBrushless);
			turnSparkMax = new CANSparkMax(DriveConstants.kBackLeftTurningPort,
					MotorType.kBrushless);
			...
			break;
		case 3:
			driveSparkMax = new CANSparkMax(DriveConstants.kBackRightDrivePort,
					MotorType.kBrushless);
			turnSparkMax = new CANSparkMax(DriveConstants.kBackRightTurningPort,
					MotorType.kBrushless);
		...
		driveSparkMax.setPeriodicFramePeriod(PeriodicFrame.kStatus2,
				(int) (1000.0 / Module.ODOMETRY_FREQUENCY));
		turnSparkMax.setPeriodicFramePeriod(PeriodicFrame.kStatus2,
				(int) (1000.0 / Module.ODOMETRY_FREQUENCY));
	...
	public void updateInputs(ModuleIOInputs inputs) {
		...
		inputs.driveVelocityRadPerSec = Units
				...
				/ DRIVE_GEAR_RATIO;
		inputs.driveAppliedVolts = driveSparkMax.getAppliedOutput()
				* driveSparkMax.getBusVoltage();
		...
		inputs.turnAppliedVolts = turnSparkMax.getAppliedOutput()
				* turnSparkMax.getBusVoltage();
	...
	@Override
	public void setTurnVoltage(double volts) { turnSparkMax.setVoltage(volts); }
