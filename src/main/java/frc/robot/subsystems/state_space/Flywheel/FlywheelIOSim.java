...
public class FlywheelIOSim implements FlywheelIO {
	...
	private FlywheelSim flywheelSim = new FlywheelSim(FlywheelS.flywheelPlant,DCMotor.getNEO(1),StateSpaceConstants.Flywheel.flywheelGearing,VecBuilder.fill(.5));
