...
public SingleJointedArmIOSpark(){
	...
	public void updateInputs(SingleJointedArmIOInputs inputs) {
		...
		inputs.positionRad = Units.rotationsToRadians(encoder.getPosition() * StateSpaceConstants.SingleJointedArm.armGearing);; 
		inputs.armTemp = arm.getMotorTemperature();
		inputs.velocityRadPerSec = Units.rotationsPerMinuteToRadiansPerSecond(encoder.getVelocity() * StateSpaceConstants.SingleJointedArm.armGearing);
