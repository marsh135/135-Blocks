...
public class GetToPoseAuto extends Command {
 ...
 //Default the TunedNumbers on boot
  ...
  public GetToPoseAuto(DrivetrainS drive, Pose2d pose, PathConstraints pathConstraints) {
    this(drive, false, pose, pathConstraints);
  }
  /** Drives to the specified pose under full software control. */
  public GetToPoseAuto(DrivetrainS drive, Pose2d pose) {
	this(drive, false, pose);
 }
  /** Drives to the specified pose under full software control. */
  public GetToPoseAuto(DrivetrainS drive, boolean slowMode, Pose2d pose) {
  ...
  /** Drives to the specified pose under full software control. */
  public GetToPoseAuto(DrivetrainS drive, boolean slowMode, Pose2d pose, PathConstraints pathConstraints) {
	this(drive, slowMode, () -> pose,pathConstraints);
 }
  /** Drives to the specified pose under full software control. */
  public GetToPoseAuto(DrivetrainS drive, Supplier<Pose2d> poseSupplier) {
  ...
  /** Drives to the specified pose under full software control. */
  public GetToPoseAuto(DrivetrainS drive, boolean slowMode, Supplier<Pose2d> poseSupplier, PathConstraints pathConstraints) {
    this.drive = drive;
  ...
  public void execute() {
    ...
    if (currentDistance < driveController.getPositionTolerance()) running = false; //if there, END. That keeps our velocity.
