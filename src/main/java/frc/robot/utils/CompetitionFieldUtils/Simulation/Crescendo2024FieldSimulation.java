...
public class Crescendo2024FieldSimulation extends CompetitionFieldSimulation {
    ...
    public static final class CrescendoFieldObstaclesMap extends FieldObstaclesMap {
        public CrescendoFieldObstaclesMap() {
            ...
            super.addRectangularObstacle(
                    0.35, 0.35,
                    new Pose2d(FieldConstants.FIELD_WIDTH-3.4, 4.1, new Rotation2d())
            );
            super.addRectangularObstacle(
                    0.35, 0.35,
                    new Pose2d(FieldConstants.FIELD_WIDTH-5.62, 4.1-1.28, Rotation2d.fromDegrees(60))
            );
            super.addRectangularObstacle(
                    0.35, 0.35,
                    new Pose2d(FieldConstants.FIELD_WIDTH-5.62, 4.1+1.28, Rotation2d.fromDegrees(30))
            );
        }
    }
}
