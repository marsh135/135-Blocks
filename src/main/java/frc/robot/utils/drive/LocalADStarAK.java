...
public class LocalADStarAK implements Pathfinder {
	 ...
	 */
	@Override
	public PathPlannerPath getCurrentPath(PathConstraints constraints,
		...
		return PathPlannerPath.fromPathPoints(io.currentPathPoints, constraints,
				goalEndState);
	}
	...
	private static class ADStarIO implements LoggableInputs {
		...
		public void updateCurrentPathPoints(PathConstraints constraints,
				GoalEndState goalEndState) {
			PathPlannerPath currentPath = adStar.getCurrentPath(constraints,
					goalEndState);
			if (currentPath != null) {
