...
public class Angles {
	...
	/**
	 * gets the shortest rotational distance(and its direction) needed to get
	 * from the current to targeted rotation
	 *
	 * @param currentRotation  the current rotation, in radian
	 * @param targetedRotation the desired rotation, in radian
	 * @return the shortest distance between the two points, in radian and
	 *         positive is counter-clockwise
	 */
	public static double getActualDifference(double currentRotation,
			double targetedRotation) {
	 ...
	 */
	public static double findMidPointBetweenCurve(double rotation1,
			double rotation2) {
